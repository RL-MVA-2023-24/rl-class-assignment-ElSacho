...
class dqn_agent:
    def __init__(self, config, model):
        ...
        self.memory = PrioritizedStandardBuffer(self.obs_space, self.batch_size, buffer_size, device, True)
...
model = DQM_model(state_dim*config['n_state_to_agg'], 256, n_action, 6).to(device)
