...
import numpy as np
from try.replay_memory import ReplayBuffer, PrioritizedReplayBuffer
...
PRED_PATH = './data/model/C51_pred_net_.pkl'
TARGET_PATH = './data/model/C51_target_net_.pkl'
RESULT_PATH = './data/plots/C51_result_.pkl'
